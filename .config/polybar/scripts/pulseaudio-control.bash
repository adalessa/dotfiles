...
SINK_BLACKLIST=(
    "alsa_output.pci-0000_27_00.1.hdmi-stereo-extra5"
)

# Maps PulseAudio sink names to human-readable names
declare -A SINK_NICKNAMES
SINK_NICKNAMES["alsa_output.usb-Logitech_Logitech_G430_Gaming_Headset-00.analog-stereo"]="  Auris"
SINK_NICKNAMES["alsa_output.pci-0000_29_00.3.analog-stereo"]=" Parlante"
